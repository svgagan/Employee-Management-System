...
<title>EMS - Manager Dashboard Page</title>
</head>
<body bgcolor="#ffcccc">
	<center>
	...
	<table>
		...
		<tbody>
		<tr style="display: none;"><td>ManagerId</td><td><input value="<%=register.getId()%>" name="id" type="text" placeholder="ManagerId" disabled="disabled"></td></tr>
